...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909102522_AddShareSnapshots') THEN
    CREATE TABLE share_settings (
        id integer GENERATED BY DEFAULT AS IDENTITY,
        link_validity_days integer NOT NULL,
        updated_at timestamp with time zone NOT NULL,
        CONSTRAINT "PK_share_settings" PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE share_snapshots (
        ...
        CONSTRAINT "PK_share_snapshots" PRIMARY KEY (token)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909102522_AddShareSnapshots') THEN
    CREATE INDEX "IX_share_snapshots_expires_at" ON share_snapshots (expires_at);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909102522_AddShareSnapshots') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260909102522_AddShareSnapshots', '10.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909103211_AddShareRetention') THEN
    ALTER TABLE share_snapshots ADD retain_until timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909103211_AddShareRetention') THEN
    CREATE INDEX "IX_share_snapshots_retain_until" ON share_snapshots (retain_until);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909103211_AddShareRetention') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260909103211_AddShareRetention', '10.0.11');
    END IF;
END $EF$;
COMMIT;
