        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderCode = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    CredentialHint = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    LatitudeBucket = table.Column<double>(type: "REAL", nullable: true),
                    LongitudeBucket = table.Column<double>(type: "REAL", nullable: true),
                    RangeStartUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    RangeEndUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
