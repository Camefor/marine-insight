        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    algorithm_version = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    source_set_hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    activity_type = table.Column<short>(type: "INTEGER", nullable: true),
                    score = table.Column<double>(type: "REAL", nullable: true),
                    risk_level = table.Column<short>(type: "INTEGER", nullable: false),
                    confidence = table.Column<double>(type: "REAL", nullable: false),
                    recommended_start = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    recommended_end = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    return_before = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    summary_template_code = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    analysis_result_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    forecast_time = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    rule_code = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    severity = table.Column<short>(type: "INTEGER", nullable: false),
                    actual = table.Column<double>(type: "REAL", nullable: true),
                    threshold = table.Column<double>(type: "REAL", nullable: true),
                    penalty = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_role = table.Column<short>(type: "INTEGER", nullable: false),
                    ...
                    source_model = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    selection_policy = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false)
                },
                constraints: table =>
                {
